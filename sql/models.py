...
class SqlWorkflow(models.Model):
    ...
    demand_url = models.CharField('需求链接', max_length=200, default='无')
    group_id = models.IntegerField('组ID')
    group_name = models.CharField('组名称', max_length=100)
    instance = models.ForeignKey(Instance, on_delete=models.CASCADE)
    db_regex = models.CharField('数据库正则', max_length=256, default='^.+$')
    ...
    engineer = models.CharField('发起人', max_length=30, default='admin')
    engineer_display = models.CharField('发起人中文名', max_length=50, default='管理员')
